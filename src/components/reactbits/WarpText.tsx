...
const buildTextCanvas = ({ container, width, height, dpr, props }: BuildCanvasOptions) => {
  ...
  let resolvedColor = props.color || '#ffffff';
  if (typeof props.color === 'string' && props.color.includes('var(')) {
    resolvedColor = computed.color || '#ffffff';
  }
...
const syncUniforms = (program: any, props: Record<string, any>) => {
