...
export default function HomeClient() {
  ...
  return (
    <div>
      {/* ── Hero ── */}
      <section className="relative px-4 sm:px-6 pt-8 pb-12 sm:pt-16 sm:pb-20 section-fade-b overflow-hidden">
      ...
      {/* ── How it works ── */}
      <section className="section-fade-t section-fade-b relative px-4 sm:px-6 py-14 cv-auto overflow-hidden" style={{ background: "color-mix(in srgb, var(--bg-elevated) 40%, var(--bg))" }}>
      ...
      <section className="px-4 sm:px-6 pt-10 pb-28 sm:pb-16 max-w-6xl mx-auto">
        ...
        {filteredCategories.map((cat) => {
          ...
          return (
            ...
            >
              <div className="section-fade-b flex items-baseline justify-between mb-4 pb-3">
      ...
      {/* ── Footer ── */}
      <footer className="section-fade-t px-4 sm:px-6 py-10">
