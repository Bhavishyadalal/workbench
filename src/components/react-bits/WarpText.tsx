...
const WarpText = ({
  ...
  useEffect(() => {
    ...
    /* eslint-disable @typescript-eslint/no-explicit-any --
       these are forward-declared so cleanup/event closures below can
       reference them; each is assigned exactly once further down. */
    let renderer: any;
    let gl: any;
    let program: any;
    let geometry: any;
    ...
    const rasterize = async () => {
      ...
      const textCanvas = buildTextCanvas({
        ...
        height: rect.height,
        dpr,
        props: propsRef.current as TextCanvasProps,
      });
